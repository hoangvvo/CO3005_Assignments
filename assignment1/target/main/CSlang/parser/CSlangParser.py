...
class CSlangParser ( Parser ):
    ...
    class Attribute_decl_bodyContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitAttribute_decl_body" ):
                return visitor.visitAttribute_decl_body(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Attribute_decl_inner_without_initContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitAttribute_decl_inner_without_init" ):
                return visitor.visitAttribute_decl_inner_without_init(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Attribute_decl_inner_with_initContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitAttribute_decl_inner_with_init" ):
                return visitor.visitAttribute_decl_inner_with_init(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Attribute_decl_inner_with_init_tailContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitAttribute_decl_inner_with_init_tail" ):
                return visitor.visitAttribute_decl_inner_with_init_tail(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Assign_stmt_bodyContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitAssign_stmt_body" ):
                return visitor.visitAssign_stmt_body(self)
            else:
                return visitor.visitChildren(self)
    ...
    class For_stmt_innerContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitFor_stmt_inner" ):
                return visitor.visitFor_stmt_inner(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Method_invocation_stmt_bodyContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitMethod_invocation_stmt_body" ):
                return visitor.visitMethod_invocation_stmt_body(self)
            else:
                return visitor.visitChildren(self)
