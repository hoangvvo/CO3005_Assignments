...
class ASTGeneration(CSlangVisitor):
    ...
    def visitClassdecl(self, ctx:CSlangParser.ClassdeclContext) -> ClassDecl:
        return ClassDecl(
            Id(ctx.ID().getText()),
            flatten(
                [self.visit(x) for x in ctx.memdecl()]
            ),
    ...
    def visitAttributedecl(self, ctx:CSlangParser.AttributedeclContext) -> List[AttributeDecl]:
        return self.visit(ctx.attributedecl_body())


    # Visit a parse tree produced by CSlangParser#attributedecl_body.
    def visitAttributedecl_body(self, ctx:CSlangParser.Attributedecl_bodyContext) -> List[AttributeDecl]:
        attributeDecls = self.visit(ctx.attributedecl_inner_with_init()) if ctx.attributedecl_inner_with_init() else self.visit(ctx.attributedecl_inner_without_init())
    ...
    def visitAttributedecl_inner_without_init(self, ctx:CSlangParser.Attributedecl_inner_without_initContext):
    ...
    def visitAttributedecl_inner_with_init(self, ctx:CSlangParser.Attributedecl_inner_with_initContext):
    ...
    def visitConstructormethod(self, ctx:CSlangParser.ConstructormethodContext) -> MethodDecl:
        return MethodDecl(
    ...
    def visitParamlist(self, ctx:CSlangParser.ParamlistContext) -> List[VarDecl]:
        return [
            y for x in ctx.param() for y in self.visit(x)
        ]
